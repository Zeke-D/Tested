...
var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "formContainer svelte-42o5o1");
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(blockquote, file$4, 47, 2, 1378);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:0) {#each errors as error, i}",
    		ctx
    	});
    ...
    // (52:0) {#if domTimeSelect !== undefined}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "mapContainer svelte-115togk");
    			add_location(div, file$4, 52, 2, 1557);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*$$scope, currentLocation, domTimeSelect*/ 131084) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(52:0) {#if domTimeSelect !== undefined}",
    		ctx
    	});
    ...
    // (59:6) {#if currentLocation.latitude !== undefined && currentLocation.longitude !== undefined}
    function create_if_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(59:6) {#if currentLocation.latitude !== undefined && currentLocation.longitude !== undefined}",
    		ctx
    	});
    ...
    // (54:4) <Map       accessToken="{apiPublicKey}"       bind:this={mapComponent}       style="mapbox://styles/pseudonymonty/ckeggpduq00t619pnkcdgcang"     >
    function create_default_slot(ctx) {
    	...
    	navigationcontrol = new /*NavigationControl*/ ctx[4]({ $$inline: true });
    	scalecontrol = new /*ScaleControl*/ ctx[5]({ $$inline: true });
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(54:4) <Map       accessToken=\\\"{apiPublicKey}\\\"       bind:this={mapComponent}       style=\\\"mapbox://styles/pseudonymonty/ckeggpduq00t619pnkcdgcang\\\"     >",
    		ctx
    	});
    ...
    function create_fragment$8(ctx) {
    	...
    	function timeselect_domRep_binding(value) {
    		/*timeselect_domRep_binding*/ ctx[9].call(null, value);
    	}
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			insert_dev(target, t0, anchor);
    			mount_component(timeselect, target, anchor);
    			insert_dev(target, t1, anchor);
    			mount_component(timefinder, target, anchor);
    		...
    		d: function destroy(detaching) {
    			destroy_each(each_blocks, detaching);
    			if (detaching) detach_dev(t0);
    			destroy_component(timeselect, detaching);
    			if (detaching) detach_dev(t1);
    			destroy_component(timefinder, detaching);
    ...
    class TestedMap extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { errors: 0, range: 8 });
    ...
    function create_fragment$9(ctx) {
    	...
    	let testedmap;
    	let current;
    	testedmap = new TestedMap({ $$inline: true });

    	const block = {
    		c: function create() {
    			main = element("main");
    			create_component(testedmap.$$.fragment);
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(testedmap, main, null);
    			current = true;
    		},
    		p: noop,
    		i: function intro(local) {
    			if (current) return;
    			transition_in(testedmap.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(testedmap.$$.fragment, local);
    			current = false;
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(main);
    			destroy_component(testedmap);
    		}
    	};
